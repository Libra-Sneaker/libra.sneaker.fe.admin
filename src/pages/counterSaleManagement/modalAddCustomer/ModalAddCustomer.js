...
const ModalAddCustomer = ({ isModalOpenCustomer, handleCancelCustomer }) => {
  ...
  const handleOk = async () => {
    ...
    try {
      ...
      handleCancelCustomer(); // Đóng modal
    }
  };
  ...
  return (
    <Modal
      ...
      footer={[
        ...
        <Popconfirm
          title="Bạn có chắc muốn thêm khách hàng này không?"
          onConfirm={handleOk}
          okText="Có"
          cancelText="Không"
        >
              ...
              <Col span={12}>
                ...
                >
                  <DatePicker
                    ...
                    format="YYYY-MM-DD"
                    value={
                      dateOfBirth ? dayjs(dateOfBirth, "YYYY-MM-DD") : null
                    } // Chuyển đổi thành dayjs object
